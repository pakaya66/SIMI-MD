...
case 'video': case 'ytmp4': case 'yt': {
    ...
    try {
        ...
        if (apiResponse.data.success) {
            ...
            replygcxeon(`*Error fetching the video! Please try again later.*`);
        }
    } catch (error) {
...
case 'facebook': case 'fbbb': case 'fbdl': case 'fbdownload': {
    if (!text) {
