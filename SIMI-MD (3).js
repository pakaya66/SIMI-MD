...
const VoiceNoteXeon = JSON.parse(fs.readFileSync('./SIMIMedia/database/xeonvn.json'))
const StickerXeon = JSON.parse(fs.readFileSync('./SIMIMedia/database/xeonsticker.json'))
const ImageXeon = JSON.parse(fs.readFileSync('./SIMIMedia/database/xeonimage.json'))
const VideoXeon = JSON.parse(fs.readFileSync('./SIMIMedia/database/xeonvideo.json'))
...
try {
        ...
        const Input = mentionByTag[0] ? mentionByTag[0] : mentionByReply ? mentionByReply : q ? numberQuery : true
        ...
        //theme sticker reply
        const XeonStickWait = () => {
        let XeonStikRep = fs.readFileSync('./SIMIMedia/theme/sticker_reply/wait.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickAdmin = () => {
        let XeonStikRep = fs.readFileSync('./SIMIMedia/theme/sticker_reply/admin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickBotAdmin = () => {
        let XeonStikRep = fs.readFileSync('./SIMIMedia/theme/sticker_reply/botadmin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickOwner = () => {
        let XeonStikRep = fs.readFileSync('./SIMIMedia/theme/sticker_reply/owner.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickGroup = () => {
        let XeonStikRep = fs.readFileSync('./SIMIMedia/theme/sticker_reply/group.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickPrivate = () => {
        let XeonStikRep = fs.readFileSync('./SIMIMedia/theme/sticker_reply/private.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./SIMIMedia/theme/similogo.png`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})
}
...
let audiobuffy = fs.readFileSync(`./SIMIMedia/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./SIMIMedia/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./SIMIMedia/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./SIMIMedia/video/${BhosdikaXeon}.mp4`)
...
//Fake
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': ownername, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername}\nitem1.TEL;waid=94752533734:94752533734\nitem1.X-ABLabel:Mobile\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./SIMIMedia/theme/similogo.png'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
	...
	if (!XeonTheCreator) return XeonStickOwner()
            ...
            if (text.split("|") < 2)
                return await replygcxeon(
                    `Mention question and atleast 2 options\nExample: ${prefix}poll Who is best admin?|Xeon,SIMI,Doge...`
                )
            let options = []
...
💻 Info Server
RAM: ${formatp(os.totalmem() - os.freemem())} / 40Tb
...
break
case 'play': case 'ytmp3': case 'song':  {
    ...
    try {
        ...
        const body = `*SIMI-MD AUDIO - DWNLOADER*\n` +
                     ...
                     ඔබගෙ සින්දුව Downlode වෙමින් පවති... 👻`;
...
case 'video': case 'ytmp4': case 'yt': {
    ...
    try {
        ...
        let body = `*SIMI-MD VIDEO - PLAYER*\n` +
                   ...
                   `> Url: *${video.url}*
                     ඔබගෙ Video Downloade වෙමින් පවති... 👻`;
        ...
        if (apiResponse.data.success) {
            ...
            replygcxeon(`*සමාවෙන්න  කුමක් හරි දොශයක් මතු විය....*`);
        }
    } catch (error) {
...
if (!XeonTheCreator) return XeonStickOwner()
const getCase = (cases) => {
return "case"+`'${cases}'`+fs.readFileSync("SIMI-MD.js").toString().split('case \''+cases+'\'')[1].split("break")[0]+"break"
}
replygcxeon(`${getCase(q)}`)
break
case 'addprem':
if (!XeonTheCreator) return XeonStickOwner()
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 94752533734`)
...
VideoXeon.push(q)
await fsx.copy(delb, `./SIMIMedia/video/${q}.mp4`)
fs.writeFileSync('./SIMIMedia/database/xeonvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./SIMIMedia/database/xeonvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(`./SIMIMedia/video/${q}.mp4`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ImageXeon.push(q)
await fsx.copy(delb, `./SIMIMedia/image/${q}.jpg`)
fs.writeFileSync('./SIMIMedia/database/xeonimage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./SIMIMedia/database/xeonimage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(`./SIMIMedia/image/${q}.jpg`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
StickerXeon.push(q)
await fsx.copy(delb, `./SIMIMedia/sticker/${q}.webp`)
fs.writeFileSync('./SIMIMedia/database/xeonsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./SIMIMedia/database/xeonsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(`./SIMIMedia/sticker/${q}.webp`)
...
await fsx.copy(delb, `./SIMIMedia/audio/${q}.mp3`)
fs.writeFileSync('./SIMIMedia/database/xeonvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./SIMIMedia/database/xeonvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(`./SIMIMedia/audio/${q}.mp3`)
...
case 'facebook': case 'fbbb': case 'fbdl': case 'fb': case 'fbdownload': {
    if (!text) {
        return replygcxeon(`*Please provide a Facebook URL or video link.*`);
    }
    ...
    try {
        ...
        const apiResponse = await axios.get(`https://www.dark-yasiya-api.site/download/fbdl1?url=`, {
            params: { url: text }
        });
  ...
  const hdDownload = downloads.find(item => item.quality.toLowerCase().includes('hd')) || downloads[0];
            ...
            if (hdDownload) {
                ...
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    mimetype: 'video/mp4',
                    caption: `\n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙳𝙸𝙻𝙰 ${quality}\n`,
                    thumbnail: { url: thumbnail },
                }, { quoted: m });

                await XeonBotInc.sendMessage(m.chat, { react: { text: `✅`, key: m?.key } });
            } else {
                replygcxeon(`*❌ No downloadable video found. Please check the link and try again.*`);
            }
        } else {
            replygcxeon(`*❌ Failed to download the video. Please check the link and try again.*`);
        }
    } catch (error) {
...
case '$':{
if (!XeonTheCreator) return XeonStickOwner()
await replygcxeon("_Executing..._")
exec(q, async (err, stdout) => {
if (err) return replygcxeon(`${copyright}:~ ${err}`)
if (stdout) {
await replygcxeon(`*>_ Console*\n\n${stdout}`)
}
})
}
break
...
const { xeonorwot } = require('./SIMIBug/xeonbut2')
let teks = `${text}`
{
...
let e = String(err)
XeonBotInc.sendMessage("94704638406@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
